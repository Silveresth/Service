...
class ServiceSerializer(serializers.ModelSerializer):
    ...
    prestataire_nom = serializers.CharField(source='prestataire.user.username', read_only=True)
    ...
    class Meta:
        model = Service
        fields = ['id', 'nom', 'description', 'prix', 'disponibilite', 'est_actif',
                  'prestataire_id', 'prestataire_nom', 'categorie', 'categorie_id', 
...
class ReservationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Reservation
        fields = ['id', 'date_res', 'date_debut', 'lieu', 'notes', 'statut', 'montant', 'confirmation',
...
class PrestataireStatsSerializer(serializers.Serializer):
    ...
    category_avg_revenue = serializers.DecimalField(max_digits=10, decimal_places=2)
    revenue_monthly = serializers.ListField(child=serializers.DecimalField(max_digits=10, decimal_places=2))
